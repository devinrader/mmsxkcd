...
var subscribersRef = new Firebase("https://vivid-fire-8972.firebaseio.com/subscribers");
	...
	var client = new twilio.RestClient(process.env.TWILIO_ACCOUNT_SID, process.env.TWILIO_AUTH_TOKEN);   
          ...
          for(var i=0; i < req.body.items.length; i++) {
                    ...
                    parseString(item.summary, function (err, result) {
                              ...
                              var title = result.img.$.title; console.log(title);
                              var src = result.img.$.src; console.log(src);
